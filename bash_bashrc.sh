...
#echo -e "\n\n************************************************************\n******  Entering Personal Bash Configuration \n************************************************************\n"
...
for file_itr in $(ls /etc/bash_completion.d  -I lldpad -I lldptool -I fcoemon -I fcoeadm)
  do
    file_completion="/etc/bash_completion.d/${file_itr}"
    #echo -e "${file_completion}"
    . ${file_completion}
  done
